---
title: Top Extensões Úteis para VSCode - 2020
description: Que o VSCode virou a IDE favorita da comunidade não é nenhuma
  novidade, ela facilita diariamente a vida de muitos desenvolvedores. Podemos
  otimizar ainda mais o nosso processo de desenvolvimento utilizando algumas
  extensões super úteis. Separei uma lista com as extensões que eu uso e
  recomendo para melhorar sua produtividade.
date: 2020-07-10T22:15:28.000Z
lang: pt
translationKey: top-extensoes-uteis-para-vscode-2020
slug: top-extensoes-uteis-para-vscode-2020
category: tecnologia
tags:
  - extensions
  - vscode
...
Que o VSCode virou a [IDE](http://marquesfernandes.com/melhores-editores-de-texto-ides-para-desenvolvimento-web-em-2020/) favorita da comunidade não é nenhuma novidade, ela facilita diariamente a vida de muitos desenvolvedores. Podemos otimizar ainda mais o nosso processo de desenvolvimento utilizando algumas extensões super úteis. Separei uma lista com as extensões que eu uso e recomendo para melhorar sua produtividade.
...
Essa extensão é excelente pra você descobrir que aquele código que você está xingando, foi na verdade, feito por você mesmo.
...
[![Remote SSH](https://microsoft.github.io/vscode-remote-release/images/ssh-readme.gif)](https://marketplace.visualstudio.com/items?itemName=ms-vscode-remote.remote-ssh)

A extensão Remote - SSH permite usar qualquer máquina remota com um servidor SSH como seu ambiente de desenvolvimento. Isso pode simplificar bastante o desenvolvimento e a solução de problemas em uma ampla variedade de situações.

-   Desenvolva no mesmo sistema operacional que você implementa ou usa uma infraestrutura maior, mais rápida ou mais especializada que a sua máquina local.
-   Troque rapidamente entre diferentes ambientes de desenvolvimento remoto e faça atualizações com segurança, sem se preocupar em impactar sua máquina local.
-   Acesse um ambiente de desenvolvimento existente de várias máquinas ou locais.
-   Depure um aplicativo em execução em outro lugar, como um site de cliente ou na nuvem.
...
Um verificador ortográfico básico que funciona bem com o código camelCase. O objetivo desse verificador ortográfico é ajudar a detectar erros ortográficos comuns, mantendo baixo o número de falsos positivos.
...
Essas extensões ajudam muito na minha produtividade, e você? Tem alguma extensão que usa e acha útil? Deixe nos comentários!
