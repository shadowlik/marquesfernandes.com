---
title: O que é um Servidor e para que serve?
description: Um servidor pode ser definido como um software e/ou computador que
  fornece serviços específicos para um cliente. Provavelmente quando você escuta
  alguém falar de um servidor, ele está se referindo a uma máquina dedicada para
  executar um sistema ou aplicação, basicamente um servidor é uma máquina
  conectada a internet que recebe e responde solicitações e que normalmente está
  ligado 24 horas por dia, 7 dias por semana.
date: 2020-08-01T22:31:02.000Z
lang: pt
translationKey: o-que-e-um-servidor-e-para-que-serve
slug: o-que-e-um-servidor-e-para-que-serve
category: tecnologia
tags:
  - servidor
  - cloud
