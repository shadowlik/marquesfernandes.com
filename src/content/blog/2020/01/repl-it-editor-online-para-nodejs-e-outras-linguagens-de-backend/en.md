---
title: "Repl.it: Online editor for NodeJS and other backend languages"
description: If you are looking for a versatile tool to create prototypes or
  test some code, check out Repl.it, it has been very useful in my day-to-day,
  especially when I need to validate some programming logic or even test a lib
  without having to create the whole the setup of a project from scratch.
date: 2020-01-26T20:37:51.000Z
lang: en
translationKey: repl-it-editor-online-para-nodejs-e-outras-linguagens-de-backend
slug: repl-it-online-editor-for-nodejs-and-other-backend-languages
category: technology
tags: []
wpId: 12013
canonicalPath: /en/technology/repl-it-online-editor-for-nodejs-and-other-backend-languages/
needsReview: false
...
[Moon](https://repl.it/languages/lua)  
...
[Ç](https://repl.it/languages/c)  
[Ç#](https://repl.it/languages/csharp)  
...
[neem](https://repl.it/languages/nim)  
...
[Pixel](https://repl.it/languages/pyxel)
