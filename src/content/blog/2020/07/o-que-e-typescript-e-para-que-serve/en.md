---
title: What is TypeScript and what is it for?
description: TypeScript is a typed superset of JavaScript that is compiled to
  pure JavaScript. It follows the JavaScript standard and is also a
  multi-paradigm language, however it adds object-oriented functionality and
  syntax, classes and typing seen in languages like C# and Java.
date: 2020-07-08T22:18:33.000Z
lang: en
translationKey: o-que-e-typescript-e-para-que-serve
slug: what-is-typescript-is-what-is-it-for
category: technology
tags: []
wpId: 11904
canonicalPath: /en/technology/what-is-typescript-is-what-is-it-for/
needsReview: false
updated: 2021-12-12T11:16:58.000Z
---

**TypeScript** is a typed superset of [JavaScript](http://marquesfernandes.com/javascript-o-que-e-como-funciona-e-para-que-serve/) which is compiled to pure JavaScript. It follows the JavaScript standard and is also a multi-paradigm language, however it adds object-oriented functionality and syntax, classes and typing seen in languages like C# and Java.

It was considered by the public the 4th "most loved" language, according to a survey conducted by the Stack Overflow website in 2018, and is among the 15 most popular languages, according to a survey conducted by [RedMonk](https://redmonk.com/) .
