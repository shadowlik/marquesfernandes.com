---
title: What is a frontend developer and what does it do?
description: A front-end developer is responsible for the front-end development
  of the graphical user interface of web applications. They work mainly with
  HTML, CSS and Javascript technologies.
date: 2020-08-16T18:16:01.000Z
lang: en
translationKey: o-que-e-um-desenvolvedor-frontend-e-o-que-ele-faz
slug: what-is-a-frontend-developer-and-what-does-he-do
category: technology
tags: []
wpId: 12269
canonicalPath: /en/technology/what-is-a-frontend-developer-and-what-does-he-do/
needsReview: false
updated: 2021-12-12T11:20:18.000Z
---

A front-end developer is responsible for the front-end development of the graphical user interface of web applications. They work mainly with technologies [HTML](http://marquesfernandes.com/tecnologia/o-que-e-html-e-para-que-serve/) , [CSS](http://marquesfernandes.com/tecnologia/o-que-e-css-e-para-que-serve/) and [JavaScript](http://marquesfernandes.com/desenvolvimento/javascript-o-que-e-como-funciona-e-para-que-serve/) . different from [backend](http://marquesfernandes.com/tecnologia/o-que-e-um-desenvolvedor-backend-e-o-que-ele-faz/) , which has many different programming languages, the frotend technology dynamism is mainly in the [frameworks](http://marquesfernandes.com/tecnologia/framework-x-biblioteca-x-toolkit-o-que-sao-e-qual-a-diferenca/) , which are libraries optimized for web development.
...
> 
> [What is HTML - Marques Fernandes](http://marquesfernandes.com/tecnologia/o-que-e-html-e-para-que-serve/)

### [CSS](http://marquesfernandes.com/tecnologia/o-que-e-css-e-para-que-serve/)

> **Ç** ascading **s** style **s** heets ( **CSS** ) is a design language made to simplify the presentation and customization of web pages ( **[HTML](http://marquesfernandes.com/o-que-e-html-e-para-que-serve/)** ). We can think of CSS as skin or even clothing, it is responsible for applying all the visual customizations like font size and color, background color, and much more. 
> 
> [What is CSS - Marques Fernandes](http://marquesfernandes.com/tecnologia/o-que-e-css-e-para-que-serve/)
...
> 
> [What is JavaScript - Marques Fernandes](http://marquesfernandes.com/desenvolvimento/javascript-o-que-e-como-funciona-e-para-que-serve/)
