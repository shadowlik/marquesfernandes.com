---
title: "What is a backend developer and what do they do?"
description: "Back-end development is server-side development. It is the term used for the development that happens behind the scenes, unseen by users."
date: 2020-08-16T15:54:14.000Z
lang: en
translationKey: o-que-e-um-desenvolvedor-backend-e-o-que-ele-faz
slug: what-is-a-backend-developer-and-what-do-they-do
category: tecnologia
tags:
  - frontend
  - nodejs
...
needsReview: true
canonicalPath: /en/what-is-a-backend-developer-and-what-do-they-do/
---

Back-end development is server-side development. It is the term used for the development that happens behind the scenes, unseen by users. In other words, back-end developers build the business rules, the logic that makes a web system work correctly, and they do this through the use of programming languages specific to the server side, such as [NodeJS](http://marquesfernandes.com/tecnologia/afinal-o-que-e-nodejs/), [PHP](http://marquesfernandes.com/tecnologia/o-que-e-php-e-para-que-serve/), or [Python](http://marquesfernandes.com/desenvolvimento/o-que-e-python-e-pra-que-serve/).

* * *

To better understand the concept of the backend, we need to look at the other end of a web system, the [frontend](http://marquesfernandes.com/tecnologia/o-que-e-um-desenvolvedor-frontend-e-o-que-ele-faz/).
...
The client part, which displays the information in a structured way, is developed by the frontend developer, while the part that responds to the requested information, querying the database and applying other business rules, is handled by the backend developer. Communication between these two ends is usually done through [APIs](http://marquesfernandes.com/tecnologia/o-que-e-uma-api-e-para-que-serve/) (protocols and standards for communication on the internet).

There are cases of [full-stack developers](http://marquesfernandes.com/tecnologia/o-que-e-e-o-que-faz-um-desenvolvedor-full-stack/) who are able to develop on both ends.
...
The [**node**](http://marquesfernandes.com/tecnologia/afinal-o-que-e-nodejs/) environment has everything you need to run scripts in JavaScript, which until then\* was only possible in browsers. It lets you use JavaScript as a backend language and uses the *V8 JavaScript engine* developed by Google for Chrome.

![Python](./2020-08-kwi4bvgzths31-1.jpg)

### [Python](http://marquesfernandes.com/desenvolvimento/o-que-e-python-e-pra-que-serve/)

[Python](http://marquesfernandes.com/desenvolvimento/o-que-e-python-e-pra-que-serve/) is a general-purpose interpreted programming language, very popular and usable to develop a wide variety of applications. It has high-level data structures, modules, exceptions, dynamic typing, dynamic binding, and many features.

![PHP](./2020-08-learn-php.jpg)

### [PHP](http://marquesfernandes.com/tecnologia/o-que-e-php-e-para-que-serve/)

**[PHP](http://marquesfernandes.com/tecnologia/o-que-e-php-e-para-que-serve/)** (a recursive acronym for *"**P**HP: **H**ypertext **P**reprocessor"*) is an open-source interpreted language, used mainly in server-side (backend) development of web applications.
