---
title: How to change decimal separator from comma to period and vice versa in Excel
description: When working or importing data into Excel spreadsheets from web
  pages, systems or CSV files, Excel may recognize some numbers and convert them
  to standard text type. Changing even temporarily the Excel settings helps to
  reduce the amount of manual work and the number of errors in replacing comma
  by period, semicolon, semicolon by comma, etc. Working with international data
  in Excel configured in Portuguese can be a real nightmare.
date: 2020-11-24T16:33:20.000Z
lang: en
translationKey: como-alterar-o-separador-decimal-de-virgula-para-ponto-e-vice-versa-no-excel
slug: how-to-change-decimal-separator-from-comma-to-period-and-vice-versa-in-excel
category: technology
tags: []
wpId: 11827
canonicalPath: /en/technology/how-to-change-decimal-separator-from-comma-to-period-and-vice-versa-in-excel/
needsReview: false
...
![Enter Options - Excel](/wp-content/uploads/2020/11/screenshot-nimbus-capture-2020.11.24-17_16_52-1-1024x554.jpg)

In the "File" tab, click the "Options" button, a new window will appear.

## two.Select Advanced Options

![Select Advanced Options - Excel](/wp-content/uploads/2020/11/screenshot-nimbus-capture-2020.11.24-17_18_04-1-1024x556.jpg)
