---
title: A regra do silêncio (Silêncio é ouro) - Linux
description: A regra do silêncio, também conhecida como o silêncio é ouro, é uma
  parte importante da filosofia do Unix que afirma que quando um programa não
  tem nada de surpreendente, interessante ou útil a dizer, não deve dizer nada.
  Isso significa que programas bem desenvolvidos devem tratar a atenção e a
  concentração de seus usuários como valiosas e, assim, executar suas tarefas da
  maneira mais discreta possível. Ou seja, o silêncio em si é uma virtude.
date: 2019-12-02T23:23:27.000Z
lang: pt
translationKey: a-regra-do-silencio-silencio-e-ouro-linux
slug: a-regra-do-silencio-silencio-e-ouro-linux
category: tecnologia
tags:
  - linux
  - unix
