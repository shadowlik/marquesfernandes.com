---
title: "Repl.it: Editor online para NodeJS e outras linguagens de backend"
description: Se você procura uma ferramenta versátil para criar protótipos ou
  testar algum código, confira o Repl.it, tem sido bem útil no meu dia-a-dia,
  principalmente quando preciso validar alguma lógica de programação ou até
  mesmo testar alguma lib sem precisar criar todo o setup de um projeto do zero.
date: 2020-01-26T20:37:51.000Z
lang: pt
translationKey: repl-it-editor-online-para-nodejs-e-outras-linguagens-de-backend
slug: repl-it-editor-online-para-nodejs-e-outras-linguagens-de-backend
...
Esse post não é patrocinado, infelizmente, mas tenho utilizado muito uma ferramenta e vi que muitos desenvolvedores não conhecem ainda essa ferramenta! Provavelmente muitos de vocês devem conhecer o [Codepen](https://codepen.io/) ou [JSFiddle](https://jsfiddle.net/), mas hoje vim falar de um serviço que vai além de HTML, CSS e JS.

![](./2019-09-image-13.png)

## Embed

Você pode facilmente compartilhar projetos em artigos ou com outras pessoas, abaixo um exemplo de um projeto Node:

## Linguagens

Estão disponíveis mais de 60 linguagens diferentes! Confira a lista completa:
...
[Ruby on Rails](https://repl.it/languages/rails)  
