---
title: Cómo optimizar la velocidad y el rendimiento de tu Google Chrome
description: Actualmente su navegador es probablemente el programa más
  importante en su ordenador. Todo lo que hacemos, desde correo electrónico,
...
slug: como-optimizar-la-velocidad-y-rendimiento-de-su-google-chrome
category: tecnologia-es
tags: []
wpId: 9175
canonicalPath: /es/tecnologia-es/como-optimizar-la-velocidad-y-rendimiento-de-su-google-chrome/
needsReview: false
...
Todos tenemos un amigo de abas acumulador en el navegador, si eres ese amigo, ves la necesidad real de todas las pestañas, esto termina con el rendimiento de tu navegador y, en consecuencia, tu ordenador. Ahora, si realmente crees que necesitas todas las pestañas, usa alguna extensión como [Tabs Outliner](https://chrome.google.com/webstore/detail/tabs-outliner/eggkanocgddhmamlbiijnphhppkpkmkl?hl=pt-BR) para ayudarte con eso.

[![Esquema de pestañas](https://lh3.googleusercontent.com/RBUi10kXuAme_QkuBX3kp6YRlf0tbArA0qBmg1Txg1RZ6aEmWDJBCBszuRj4O6C9Dfx4HLM1QTw=w640-h400-e365)](https://chrome.google.com/webstore/detail/tabs-outliner/eggkanocgddhmamlbiijnphhppkpkmkl?hl=pt-BR)

## 3 - Asegúrese de que su navegador esté actualizado

Otro consejo obvio pero súper importante, no sólo para la velocidad, sino también por su seguridad, Google libera constantemente actualizaciones que contienen nuevas características, ajustes de seguridad y mejoras de rendimiento. Cuando una actualización está disponible, aparecerá una alerta amarilla visible en lugar de los tres puntos en la esquina superior derecha, si desea asegurarse de que hay actualizaciones disponibles, haga clic en los tres puntos en la esquina superior derecha, Ayuda > Acerca de Google Chrome.

![Resultado de la imagen para actualizar google chrome](https://tecnoblog.net/wp-content/uploads/2018/11/Atualizar-Google-Chrome-700x326.png)

([Imagen](https://tecnoblog.net/wp-content/uploads/2018/11/Atualizar-Google-Chrome-700x326.png)[:](https://tecnoblog.net/wp-content/uploads/2018/11/Atualizar-Google-Chrome-700x326.png) [tecnoblog](https://tecnoblog.net/wp-content/uploads/2018/11/Atualizar-Google-Chrome-700x326.png))
