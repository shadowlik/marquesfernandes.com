...
Originalmente, se crearon muchas codificaciones diferentes (por ejemplo, código [Baudot](https://pt.wikipedia.org/wiki/C%C3%B3digo_Baudot)) que utilizaban un número diferente de bits por carácter hasta que finalmente AS[CII s](http://marquesfernandes.com/codigo-ascii-tabela-ascii-completa/)e convirtió en un patrón de 7 bits por carácter. Sin embargo, la mayoría de los equipos almacenan datos binarios en bytes que constan de 8 bits cada uno, por lo que ASCII no es adecuado para transferir este tipo de datos.
...
Primero encontraremos en nuestra t[abla ASCII e](http://marquesfernandes.com/codigo-ascii-tabela-ascii-completa/)l código binario correspondiente de cada letra:
...
Ahora volvemos a consultar nuestr[a tabla ASC](http://marquesfernandes.com/codigo-ascii-tabela-ascii-completa/)II buscando los binarios relacionados y anotando su número decimal correspondiente:

16 36 61 12 16 16 ?

Como podemos ver arriba, siempre necesitamos grupos completos de 24 bits, si su grupo no se completa, agregamos el marcador , que tiene un valor nulo para completar nuestro grupo. A continuación, buscamos nuestra referencia decimal [en la tabla de conversión Base6](http://marquesfernandes.com/tabela-de-caracteres-base64-completa-codificacao-decodificacao/)4:
...
Ahora necesitamos encontrar los números binarios correspondientes en nuestr[a tabla ASCI](http://marquesfernandes.com/codigo-ascii-tabela-ascii-completa/)I:
...
Ahora necesitamos encontrar los caracteres correspondientes a los números binarios en nuestr[a tabla ASCI](http://marquesfernandes.com/codigo-ascii-tabela-ascii-completa/)I:
