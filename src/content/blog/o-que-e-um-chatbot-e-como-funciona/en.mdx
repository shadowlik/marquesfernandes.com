...
description: A chatbot is artificial intelligence (AI) software that can
  simulate a conversation (or a chat) with a user in a natural way through
  messaging apps, websites, mobile apps or even the phone.
date: 2020-03-19T21:49:23.000Z
lang: en
translationKey: o-que-e-um-chatbot-e-como-funciona
slug: what-is-a-chatbot-and-how-it-works
category: technology
tags: []
wpId: 11977
canonicalPath: /en/technology/what-is-a-chatbot-and-how-it-works/
needsReview: false
...
Why are chatbots important? A chatbot is probably one of the most advanced and promising ways of interaction between humans and machines. However, from a technological point of view, a chatbot is just the natural evolution of a question answer system that uses the [natural language processing](https://medium.com/botsbrasil/o-que-%C3%A9-o-processamento-de-linguagem-natural-49ece9371cff) (NLP). Formulating answers to questions in natural language is one of the most common examples of natural language processing applied to systems at various companies.

## Brief history of Chatbots

The first conversation bot was written in the US in 1966. It was implemented by [Joseph Weizenbaum](https://en.wikipedia.org/wiki/Joseph_Weizenbaum) , computer scientist at the Massachusetts Institute of Technology, and was named [Eliza](https://en.wikipedia.org/wiki/ELIZA) .

In the early 1990s, the [Turing test](https://iaexpert.com.br/index.php/2016/07/19/historico-da-ia-teste-de-turing/) , which allows you to determine the possibility of thinking by computers. It was with him that we started to improve this tool, it consists of the following: A person talks to the person and to the computer, and the objective is to find out who the interlocutor is - a person or a machine.
...
If you are not a programmer, I recommend you hire [specialized companies](https://www.duotalk.io/) in this type of technology, now if you want to play and try to develop there are some platforms that provide the ecosystem to create your Chatbots:
