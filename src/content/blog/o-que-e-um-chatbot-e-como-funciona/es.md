---
title: ¿Qué es un Chatbot y cómo funciona?
description: Un chatbot es un software de inteligencia artificial (IA) que puede
  simular una conversación (o chat) con un usuario de una manera natural a
  través de aplicaciones de mensajería, sitios web, aplicaciones móviles, o
  incluso un teléfono.
date: 2020-03-19T21:49:23.000Z
lang: es
translationKey: o-que-e-um-chatbot-e-como-funciona
slug: que-y-un-chatbot-y-como-funciona
category: tecnologia-es
tags: []
wpId: 9155
canonicalPath: /es/tecnologia-es/que-y-un-chatbot-y-como-funciona/
needsReview: false
...
-   Robo: Recibe el mensaje y analiza la solicitud: H*ola, ¿te gustaría **conoc**er mi **saldo bancari**o?*
...
-   Robo: Recibe el mensaje y analiza la solicitud: *Hola, me gustaría **transferir** **R $ 1**00 a la **cuenta bancari**a de **Henrique Marques***
