---
title: Código ASCII - Tabela ASCII Completa
description: ASCII, do inglês American Standard Code for Information Código
  Padrão Americano para Intercâmbio de Informações. É um código de caracteres de
  7 bits, onde ca...
date: 2020-02-16T22:35:28.000Z
lang: pt
translationKey: codigo-ascii-tabela-ascii-completa
slug: codigo-ascii-tabela-ascii-completa
...
| DEC | OCT | HEX | BIN | Símbolo | Número  
HTML | Descrição |
| --- | --- | --- | --- | --- | --- | --- |
