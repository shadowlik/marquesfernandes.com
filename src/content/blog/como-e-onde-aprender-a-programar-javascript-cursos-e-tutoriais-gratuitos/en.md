---
title: How and Where to Learn JavaScript - Free Courses and Tutorials
description: Most of the quality and free content is in English, so tune your
  English and let's get down to business, I've put together a list of courses
  and tutorials to learn JavaScript!
date: 2020-04-03T13:05:10.000Z
lang: en
translationKey: como-e-onde-aprender-a-programar-javascript-cursos-e-tutoriais-gratuitos
slug: how-and-where-to-learn-to-program-javascript-courses-and-tutorials-free
category: technology
tags: []
wpId: 11943
canonicalPath: /en/technology/how-and-where-to-learn-to-program-javascript-courses-and-tutorials-free/
needsReview: false
...
I recommend you read this [article](http://marquesfernandes.com/javascript-o-que-e-como-funciona-e-para-que-serve/) , it explains a little bit about the JavaScript language and its uses.
...
THE [Udemy](https://www.udemy.com/courses/search/?price=price-free&q=javascript&sort=relevance&src=ukw) is one of the most popular course platforms today, it has courses in several categories, paid and free. The interesting thing is that their courses are made by anyone who has the disposition, it is a marketplace of courses, with excellent professors. You can choose any of the free JavaScript courses in this [link](https://www.udemy.com/courses/search/?price=price-free&q=javascript&sort=relevance&src=ukw) and start studying today.

## two. [Video Course](https://www.youtube.com/watch?v=BXqUH86F-kA&list=PLHz_AreHm4dlsK3Nr9GVvXCbpQyHQl1o1)

https://youtu.be/BXqUH86F-kA

For those people who like to learn from video, the [Video Course](https://www.youtube.com/watch?v=BXqUH86F-kA&list=PLHz_AreHm4dlsK3Nr9GVvXCbpQyHQl1o1) prepared a very nice material. A series with over 30 videos teaching you everything you need to learn about Javascript and ECMAScript, it's really worth checking it out!
...
the course of [introduction to javascript](https://www.codecademy.com/learn/introduction-to-javascript) by Codeacademy is an excellent starting material, very didactic and with a certification very well regarded by the market, nationally and internationally.
...
freeCodeCamp has been with us since 2014, offering quality courses and content. If you are a beginner and looking for an excellent course with interactive material, the [freeCodeCamp course](https://www.freecodecamp.org/learn/javascript-algorithms-and-data-structures/basic-javascript/) is made just for you.
...
THE [Interactive Tutorials](https://www.learn-js.org/) is a personal project, designed to make everyone in the world free to learn to code. The servers used to run the tutorials and the time invested in creating the tutorials are financed through advertisements. Although it's a bit basic and not as didactic, they manage to cover a good foundation that a beginner needs to learn Javascript.
